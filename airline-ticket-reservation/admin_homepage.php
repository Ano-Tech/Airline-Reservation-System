...
<html>
	...
	<body>
		<img class="logo" src="images/SkyShark.png"/> 
		<h1 id="title">
			SkyShark Airlines
		</h1>
		<div>
		...
		<table cellpadding="5">
			...
			<tr>
				<td class="admin_func"><a href="view_deactivated_and_activated_flights.php"><i class="fa fa-plane" aria-hidden="true"></i> VIew Deactivated/Activated Aircrafts</a>
				</td>
			</tr>
		</table>
	</body>
